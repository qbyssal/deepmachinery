...
public class CrucibleScreen extends HandledScreen<CrucibleScreenHandler>{
    public static final Identifier TEXTURE = new Identifier(DeepMachinery.MOD_ID,"textures/gui/crucible.png");
    ...
    private void renderProgressArrow(DrawContext context, int x, int y){
        context.drawTexture(TEXTURE, x + 68, y+49,177,0,handler.getScaledProgress(),16);
    }
